...
static void test_smp_message_build_from_buffer(void)
{
    SmpMessage *msg;
    ...
    /* a too small buffer should return in error */
    ret = smp_message_build_from_buffer(msg, buffer, 10);
    CU_ASSERT_EQUAL(ret, SMP_ERROR_BAD_MESSAGE);
...
static Test tests[] = {
    ...
    DEFINE_TEST(test_smp_message_get_int8),
    DEFINE_TEST(test_smp_message_get_uint16),
    DEFINE_TEST(test_smp_message_get_int16),
    DEFINE_TEST(test_smp_message_get_uint32),
    DEFINE_TEST(test_smp_message_get_int32),
    DEFINE_TEST(test_smp_message_get_uint64),
    DEFINE_TEST(test_smp_message_get_int64),
    DEFINE_TEST(test_smp_message_get_float),
    DEFINE_TEST(test_smp_message_get_double),
    DEFINE_TEST(test_smp_message_get_cstring),
    DEFINE_TEST(test_smp_message_get_craw),
    DEFINE_TEST(test_smp_message_set),
    DEFINE_TEST(test_smp_message_set_value),
    DEFINE_TEST(test_smp_message_set_uint8),
    DEFINE_TEST(test_smp_message_set_int8),
    DEFINE_TEST(test_smp_message_set_uint16),
    DEFINE_TEST(test_smp_message_set_int16),
    DEFINE_TEST(test_smp_message_set_uint32),
    DEFINE_TEST(test_smp_message_set_int32),
    DEFINE_TEST(test_smp_message_set_uint64),
    DEFINE_TEST(test_smp_message_set_int64),
    DEFINE_TEST(test_smp_message_set_float),
    DEFINE_TEST(test_smp_message_set_double),
    DEFINE_TEST(test_smp_message_set_cstring),
    DEFINE_TEST(test_smp_message_set_craw),
    DEFINE_TEST(test_smp_message_encode),
    DEFINE_TEST(test_smp_message_build_from_buffer),
    DEFINE_TEST(test_smp_message_static_helper_macro),
    { NULL, NULL }
};
